...
We add total_price, tax_amount, total, and day_of_week as derived fields.

The producer sends raw measurements only.
The consumer is responsible for all derived calculations.

Author: Denise Case, Daniel Miller
Date: 2026-05
...
def enrich_message(
    ...
    dt = datetime.fromisoformat(str(row.get("datetime", "")).replace("Z", "+00:00"))
